...
- **Les tablatures sont jouées uniquement par le synthétiseur d’alphaTab**, avec la soundfont MuseScore_General préparée en mémoire (`engine/soundfont.ts`). La lecture, la vitesse, les boucles et le mixage par piste restent indépendants de la chaîne d’ampli du studio.
