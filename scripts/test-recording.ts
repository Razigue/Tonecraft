...

{
  ...
  const t = { guitar: Float32Array.from([1, 2, 3, 4, 5, 6]), backing: Float32Array.from([10, 20, 30]), backingLevel: 0.5, latencyFrames: 2 };
  ...
  const alone = { guitar: Float32Array.from([1, 2, 3]), backing: null, backingLevel: 1, latencyFrames: 2 };
