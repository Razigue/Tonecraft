...
impl Control {
    ...
    /// other program. The engine itself stays, by the clock, until Quit: a
    /// page that comes back reopens the streams when the player starts again,
    /// exactly as after a first connection.
    fn report(&mut self) {
