...
**Provenance of the DI take (NFR-16).** It is Razigue Benhmida's own playing,
recorded for this project: his guitar into an interface, no amp and no
microphone anywhere in the signal. It is his to redistribute, and the site says
so — the `?` beside the demo take in `app/Rig.svelte` tells a visitor what a DI
is and that the take is the author's own playing.
